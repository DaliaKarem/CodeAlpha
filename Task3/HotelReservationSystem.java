...
public class HotelReservationSystem {
    public static void main(String[] args) {
        ...
        while (true) {
            System.out.println("1-search for available rooms, available rooms\n2-Make reservation\n3-Exit (Enter choice number)");
            ...
            switch (choice) {
                ...
                List<Room> availableRooms = hotel.getAvaRooms(category);
                ...
                case 2:
                    ...
                    if (hotel.getAvaRooms(cat).contains(new Room(roomNumber, cat, 0))) {
